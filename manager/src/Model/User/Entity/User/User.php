...
class User
{
    ...
    /**
     * Метод регистрации пользователя по электронной почте.
     *
     * @param Id $id
    ...
    /**
     * Метод подтверждения регистрации пользователя.
     */
    ...
    /**
     * Метод привязки социальной сети к аккаунту.
     *
     * @param string $network
     * @param string $identity
     */
    ...
    /**
     * Метод отправки запроса на смену электронной почты.
     *
     * @param Email $email
     * @param string $token
     */
    ...
    /**
     * Метод подтверждения смены электронной почты.
     *
     * @param string $token
     */
    ...
    /**
     * Метод восстановления пароля пользователя.
     *
     * @param \DateTimeImmutable $date
     * @param string $hash
     */
